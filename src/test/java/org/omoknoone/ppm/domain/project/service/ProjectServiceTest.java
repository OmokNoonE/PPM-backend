...
class ProjectServiceTest {
    ...
    void viewStartDate() {
        ...
        LocalDate expectedStartDate = LocalDate.of(2024, 5, 29); // Replace with the expected start date
    ...
    void viewEndDate() {
        ...
        LocalDate expectedEndDate = LocalDate.of(2024, 6, 8); // Replace with the expected start date
    ...
    void viewProjectList() {
        ...
        // given
        String employeeId = "EP001"; // Replace with an employee ID that exists in your test database
    ...
    void viewProject() {
        ...
        String expectedProjectTitle = "수정한 프로젝트"; // Replace with the expected project title
        String expectedProjectStartDate = "2024-05-29"; // Replace with the expected start date
        String expectedProjectEndDate = "2024-06-08"; // Replace with the expected end date
        String expectedProjectStatus = "종료"; // Replace with the expected project status
