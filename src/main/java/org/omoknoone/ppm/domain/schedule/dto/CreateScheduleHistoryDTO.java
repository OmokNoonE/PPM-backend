...
@Setter
@ToString
public class CreateScheduleHistoryDTO {
    ...
    @Builder
    public CreateScheduleHistoryDTO(Long scheduleHistoryId, String scheduleHistoryReason, LocalDateTime scheduleHistoryModifiedDate, Boolean scheduleHistoryIsDeleted, LocalDateTime scheduleHistoryDeletedDate, Long scheduleHistoryScheduleId, Long scheduleHistoryProjectMemberId) {
